...
This project is a solution to the FAQ Accordion Challenge from [Frontend Mentor](https://www.frontendmentor.io/challenges/faq-accordion-wyfFdeBwBz). The goal of the challenge is to build an accordion-style FAQ (Frequently Asked Questions) component.
...
1. Clone this repository to your local machine using the following command:
   ...
   ```
   git clone https://github.com/OmPreetham/faq-accordion.git
   ```
